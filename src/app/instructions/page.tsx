...
const steps = [
  ...
  {
    title: "Duration",
    body: "The study takes approximately 7 minutes. Please complete it in one sitting without interruption. Do not close the browser tab or navigate away during the task.",
  },
];
